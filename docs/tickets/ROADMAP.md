...
| ASC-13 | **Submit build 38, not 37** (2026-09-24): 38 carries the paywall's auto-renewal disclosure (App Review 3.1.2), the honest benefit list and the FAQ fixes (APP-14), plus APP-5/7, MKT-4. Before submitting, paste the updated description from `STORE_METADATA.md` §3 (now ends with the Terms of Use and Privacy links, and the renewal terms) and the review notes from §7. Then add both subscriptions to the version and Submit for Review once ASC-1–6 clear. | Juan | P0 | blocked |
...
| APP-14 | In-app claims audit (2026-09-24), ships in build 38+. **Paywall:** the trial timeline promised "We'll send you a reminder" but nothing schedules one, so it now just marks the date; the per-month/per-year math had a hard-coded "$" and now uses the storefront currency; the benefits listed free features ("import from anywhere", "smart plans and lists") and now list exactly what Club lifts (unlimited saves, imports, asks). **FAQ:** "Otto Club is opening soon" is replaced with what it is; "where does my data live" wrongly put the cooking journal in the account (it is device-only) and said the shopping list never leaves the phone (a shared kitchen list syncs). A real trial-reminder push needs `syncNotifications` to stop cancelling every notification first. **Also:** the purchase screen now says the subscription renews automatically until cancelled, and cancellation wording asks for at least a day before renewal (Apple bills within 24 h of period end). | Claude | P1 | done |
...
| WEB-7 | SEO content pages: **13 of 15 live.** Added 2026-09-24: Crouton, private recipe app, import-from-any-website, Samsung Food, Instagram/TikTok/Facebook Reels guides, Mealime (it closes 2026-10-21, per mealime.com/closing), and the organize-recipes-digitally hub. The Yummly page no longer recommends Mealime. Left: #15 the `/alternatives/` hub, only once 8+ alternatives exist (5 today: Crouton, Mealime, Paprika, Samsung Food, Yummly). | Claude | P2 | in progress |
...
| WEB-10 | **After 2026-10-21:** reword `/alternatives/mealime` and the Yummly page's Mealime row from "closes on 21 October" to past tense (Mealime has shut down). | Claude | P2 | todo |
