...
### N1 · Raw-vs-cooked resolution via Claude — [Cloud] — the big accuracy win left
...
### N2 · Persist the resolver cache — [Cloud build, Terminal one-line migration]
...
### N4 · Expand the cooked-record table — [Cloud]
...
### N5 · Golden nutrition corpus — [Cloud]
...
### N6 · Confidence surfaced honestly in the card — [Cloud, small]
